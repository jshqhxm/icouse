...
import com.iketang.icouse.widget.ijk.DebugLog;
import com.iketang.icouse.widget.ijk.IjkBaseMediaController;
import com.iketang.icouse.widget.ijk.OutlineTextView;
 ...
 */
public class IcMediaController extends IjkBaseMediaController {

    private static final String TAG = IcMediaController.class.getSimpleName();
...
//    private OnBackClickedListener onBackClickedListener;
    ...
    public IcMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = this;
        mFromXml = true;
    ...
    public IcMediaController(Context context) {
        super(context);
    ...
    @Override
    public void setViewBitRate(String paramString, int paramInt) {
    ...
    protected View makeControllerView() {
        return ((LayoutInflater) mContext
                ...
                R.layout.ic_mediacontroller, this);
    }
